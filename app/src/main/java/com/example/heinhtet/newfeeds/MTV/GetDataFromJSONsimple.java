...
public class GetDataFromJSONsimple {
   public static String mLink;

    public GetDataFromJSONsimple(){

    }

    public static final List<MTV> list (String link){
        mLink = link;
        ...
        List<MTV> getJSONData = extractFromJson(jsonResponse);
        return getJSONData;

    }

    private static List<MTV> extractFromJson(String jsonResponse) {

        List<MTV>arrayList = new ArrayList<>();
